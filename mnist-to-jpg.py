"""
Simple python script which takes the MNIST data from TensorFlow and builds a data set based on jpg files and text files
containing the image paths and labels. Parts of it are from the MNIST TensorFlow example.
